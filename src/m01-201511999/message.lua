...
function SetModVariables(name)
  ...
  msg.shardname={[msg.shard.master]="出生界",[msg.shard.main]="固定界",[msg.shard.summer]="永夏界",[msg.shard.winter]="永冬界",[msg.shard.cave01]="出生界洞穴",[msg.shard.cave02]="永夏界洞穴",[msg.shard.cave03]="永冬界洞穴",}
  msg.mapslink={
    [msg.shard.master]={name="出生界",   portlink={[1]=msg.shard.main,[2]=msg.shard.main,[3]=msg.shard.cave01,[4]=msg.shard.cave01}},
    [msg.shard.main]  ={name="固定界",   portlink={[1]=msg.shard.master,[2]=msg.shard.master,[3]=msg.shard.summer,[4]=msg.shard.summer,[5]=msg.shard.cave01,[6]=msg.shard.cave01,[7]=msg.shard.winter,[8]=msg.shard.winter}},
    [msg.shard.summer]={name="永夏界",   portlink={[1]=msg.shard.cave01,[2]=msg.shard.cave01,[3]=msg.shard.main,[4]=msg.shard.main,[5]=msg.shard.winter,[6]=msg.shard.winter}},
    [msg.shard.winter]={name="永冬界",   portlink={[1]=msg.shard.cave03,[2]=msg.shard.cave03,[5]=msg.shard.summer,[6]=msg.shard.summer,[7]=msg.shard.main,[8]=msg.shard.main}},
    [msg.shard.cave01]={name="出生界洞穴", portlink={[3]=msg.shard.master,[4]=msg.shard.master,[5]=msg.shard.main,[6]=msg.shard.main}},
    [msg.shard.cave02]={name="永夏界洞穴", portlink={[1]=msg.shard.summer,[2]=msg.shard.summer}},
    [msg.shard.cave03]={name="永冬界洞穴", portlink={[1]=msg.shard.winter,[2]=msg.shard.winter}},
  }
  ---指令信息
  msg.command={
    userlist ={"help","share","unshare","grant","revoke","info","ls","gather","restart"},
